package com.ebook.iText7pdf.chapter1;
...
public class C1_03_EncryptDecrypt {
	...
	public static void encryptDecrypt() throws GeneralSecurityException, IOException {
		...
		// Encrypt the message with the public key and then decrypt it with the private
		// key
		...
		// Encrypt the message with the private key and then decrypt it with the public
		// key
	...
	// This method encrypts the message (using RSA algorithm) with the key, got as
	// the 1st argument
	...
	// This method decrypts the message (using RSA algorithm) with the key, got as
	// the 1st argument
