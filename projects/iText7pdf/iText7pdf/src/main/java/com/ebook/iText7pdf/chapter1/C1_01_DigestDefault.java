...
public class C1_01_DigestDefault {
	...
	protected C1_01_DigestDefault(String password, String algorithm, String provider)
	...
	/*
	 * This method checks if the digest of the password is equal to the digest of
	 * the text line which is passed as argument
	 */
